...
class RegistrationForm(forms.ModelForm):
    password1 = forms.CharField(widget=forms.PasswordInput(), label='Id 1', \
        max_length=30, required=True)
    password2 = forms.CharField(widget=forms.PasswordInput(), label='Id 2', \
        max_length=30, required=True)
    ...
    def clean_password2(self):
        ...
        if password1 and password2 and password1 != password2:
            raise forms.ValidationError('Id różnią się')
        return password2
